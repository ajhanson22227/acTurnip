...
class _TipCalculatorAppState extends State<TipCalculator>{
  ...
  getTextInputData(){
    ...
    userOneTip % 10000 != 0 ? userOneRoundedTip = (10000 - (userOneTip % 10000) + userOneTip) : userOneRoundedTip = userOneTip;
    userTwoTip = tip * userTwoTotal;
    userTwoTip % 10000 != 0 ? userTwoRoundedTip = (10000 - (userTwoTip % 10000) + userTwoTip) : userTwoRoundedTip = userTwoTip;
